...
Function Get-Direction
{
    ...
    If($InMiles){$Units = 'imperial'}
     ...
     {
         Throw "You need to register and get an API key and save it as environment variable `$env:GoogleDirection_API_Key = `"YOUR API KEY`" `nFollow this link and get the API Key - https://developers.google.com/maps/documentation/directions/get-api-key `n`n "
     }
